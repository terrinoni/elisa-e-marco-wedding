; (function () {
	...
	var countDownDate = new Date("Sep 25, 2021 11:00:00").getTime();
	...
	var x = setInterval(function () {
		...
		if (distance < 0) {
			...
			document.getElementById("ceremony-over").style.display = "";
			document.getElementById("ceremony-over").innerHTML = "La cerimonia è conclusa!<br>Grazie per aver partecipato...";
		}
	}, 1000);
